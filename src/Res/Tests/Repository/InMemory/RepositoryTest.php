...
namespace Eki\NRW\Common\Res\Tests\Repository\InMemory;

use Eki\NRW\Common\Res\Model\ResInterface;
use Eki\NRW\Common\Res\Repository\InMemory\Repository;

use PHPUnit\Framework\TestCase;

use \stdClass;

abstract class TestRes implements ResInterface
{
	private $name;
	private $prop;
...
abstract class TestResComplex implements ResInterface
{
	private $dummy;
...
class RepositoryTest extends TestCase
{
	...
	{
		$this->repository = new Repository(TestRes::class);
	...
	{
		$repository = new Repository(InternalRes::class);
	...
	{
		$repository = new Repository(TestResComplex::class);	
...
class InternalRes implements ResInterface
{
	private $internalId;
